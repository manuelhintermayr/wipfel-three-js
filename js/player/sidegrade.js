// Equipment sidegrades (kassa "Equipment" row, ROADMAP M2a, GDD §3.12: "Ausrüstung als Sidegrade").
// Exactly one may be selected, or none – a plain closure variable behind a getter, the same shape
// js/player/belay.js#setMode and js/player/assist.js already use for a live, kassa-driven choice that
...
/** Kassa confirm / options screen (once unlocked): `null` clears the selection. */
...
/**
 * Current effect scales – read fresh every call, never cached, so a kassa change between days applies
