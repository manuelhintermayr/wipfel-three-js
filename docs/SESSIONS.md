# SESSIONS – Index (neueste oben)

Je Session eine Datei unter `docs/sessions/` (Vorlage: `docs/sessions/README.md`). Hier eine Zeile pro
Session: Datum · Nummer · Thema · Meilenstein · letzter Commit.
