...
Datenblatt aus der Recherche „Von Baum zu Baum“ (Langfassung mit Quellen:
`docs/reference/von-baum-zu-baum-recherche.html`). **Belegte Werte** stehen ohne Markierung,
**Designannahmen** sind als solche markiert. Wenn das Spiel von einem Wert abweicht, gehört ein
Satz dazu in `docs/DECISIONS.md`.
...
- Preise 2026: 16 / 20 / 29 € (ab 110/130/150 cm), 37 € Erwachsene, Saisonpass 399 €, Happy Hour
  17–18 Uhr –25 %. Saison 6. März – 26. Oktober; Hochsommer täglich 9–20 Uhr.
...
- Erfahrungswerte: 3–4 h bis zur Erschöpfung; ab Rot Armkraft nötig; Schwarz „urschwer“, kein
  Umkehren; einzelne blaue Routen wirken schwerer als rote; Google 4,7/5.
- Chronik: eröffnet 5. Juli 2012 (14 + 4 Einweisungsparcours, 135 Übungen); Nachtklettern 2014–2018
  (Lampions, Stirnlampen); Neugestaltung 2020.
...
- Seile: verzinkter/rostfreier Stahl **10–13 mm** (Flying Fox 12 mm / ½″), Pressklemmen,
  ...
  1,7–2,3 m über der Trittebene (Smart Belay X: Seilhöhe 1,6–2,1 m, Seil-Ø 10–13 mm, Zip 12–14 mm).
...
Schwierigkeitstreiber (ERCA/Betreiber): Höhe, Kraft, Gleichgewicht, Ausgesetztheit, Länge; „Extrem“ =
...
- Zulassung über Körpergröße (AT: 110/130/150 cm) oder Greifhöhe (CH/DE: 115/135/155 bzw. 160 cm)
...
- Freigabelogiken: „gelb zuerst“ (Gänsehäufel), „Panorama Express erst nach Rot“ (Rheinfall).
...
- **A** selbstschließend, nicht selbstverriegelnd · **B** selbstverriegelnd · **C** wechselseitig
  ...
  verbunden, nur mit Werkzeug lösbar. IAPA-Gütesiegel: nur C–E.
- Gen 1 (A/B): zwei Karabiner „wie am Klettersteig“, Einhandregel; Fehlerquelle Doppel-Aushängen
  (ERCA-Unfallbericht 2006/07: häufigste Absturzursache; 2007 ein Todesfall).
- Gen 2 (C/D): Edelrid Smart Belay (Bowdenzug, Falldämpfer, Rollenkarabiner, 85 cm, ~1 kg, max.
  10 m/s Zip), Smart Belay X (Magnetfreigabe erst am Stahlseil, RFID, PilotBar), Bornack SSB/LockD
  (Tweezel-Ankerpunkte), CLiC-iT (Bowdenzüge, Magnet-Ankererkennung, ohne Falldämpfer).
- Gen 3 (E): Läufer mit Öffnung kleiner als Seil-Ø, größer als Halteplatte; Kanopeo Saferoller
  (Trolley = Sicherung + Zip-Rolle) / Speedrunner (Gleithaken + separate Rolle), Koala Pouliz,
  Kong Coudou Pro/ZaZa (Schlüssel), SafetyLine (AT). Kein Überholen; Bremsen ZipBrake/SafeStop;
  zipEYE-Startblocker.
- Ausrüstung: Komplettgurt empfohlen (IAPA); Falldämpfer im Seilgarten nicht zwingend (Anlage ≤ 6 kN);
  Zip-Rolle Petzl Trac Guide (2 Rollen, 9–13 mm, max. 25 m/s); Handschuhe bei Handbremsung Pflicht;
  Helm nicht normativ (Strangulationsrisiko am Riemen vs. Anstoßschutz) – AT/DE meist Helm, CH oft ohne.
- PSA-Lebensdauer kommerziell ca. 2 Jahre (Smart Belay); jährliche PSA-Prüfung.
...
- Längen Kletterwald 30–300 m (Kahlenberg 150 m belegt; Kloten 75 m; Hornpark 210 m; Rheinfall
  > 400 m; Anif ~300 m über den See; Saalbach 1,5 km; Rekord Jebel Jais 2,83 km, 150 km/h).
- Bremsen: Gravitation (Seil steigt zum Ziel an, Auspendeln), Federblock, Bungee-Block, Reifen/Prallblock,
  Auffangnetz (Beine anziehen), Handbremse mit Lederhandschuh hinter der Rolle (ACCT-Entwurf: ab ~10 km/h
  Ankunft nur mit Backup, ab ~24 km/h verboten), Wirbelstrombremse zipSTOP (selbstregelnd, 15–150 kg,
...
- Betreuer vs. Retter; **jede Station in ≤ 10 min von einem Retter erreichbar** (IAPA); Notfallplan,
  Logbuch, jährliche Inspektion durch unabhängige Stelle (ERCA/TÜV), Baumkontrollbericht.
...
- Vergleichsparks: Gänsehäufel (Wien) 10 Parcours/79 Podeste ≤ 8 m, 26 Flying Foxes, SafetyLine (E),
  Stufen 1–9, 32 €; Seilpark Zürich (Kloten) 18 Parcours/210 Hindernisse ≤ 15 m, klassisch 2 Karabiner,
  Handschuhpflicht, 3 h, CHF 46–49; Adventure Park Rheinfall 14 + 2 Kids ≤ 15+ m, LockD, kein Helm,
  Handbremse, Panorama Express > 400 m, 3 h, CHF 41; Kletterwald Freischütz (Schwerte) 12 + 3
  Einweisung ≤ 15 m, Saferoller 2, Helm, 3 h, 29 €; Hornpark St. Johann 9 Parcours ≤ 21 m, SafetyLine,
  Helm + Handschuhe, 210-m-Bahn; Anif 12 + Mini ≤ 13 m, SSB + SafetyLine, ~300-m-Bahn über den See.
...
Parcours untersagt (Reglement Seilpark Zürich – im Spiel als „geteilte Physik“ optional erlaubt).
